...
vvar=0
ddvar=0
#Variables was created in order to identify the stat of the input
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  #The command line argument was shifted so that the next element can be processed
  shift
...
#The "if" condition was applied to verify stat of the variable
...
if [ $ddvar -gt 0 ]; then
  echo "Debug Mode is On with debug level $ddvar."
else
